...
- **던전별 제한**: 나벨 하드(4명), 황혼전(8명), 안개신/베누스(20명)
...
### API 제한
- **목요일 제한**: 오전 8시 ~ 10시 (DFO API 점검 시간)
- **동기화 제한**: 캐릭터당 2분 간격
...
### 적격성 기준
- **나벨 하드**: 명성 72,688, 버퍼 버프력 5,000,000, 딜러 총딜 10,000,000,000
- **나벨 일반**: 명성 72,688, 버퍼 버프력 4,000,000, 딜러 총딜 10,000,000,000
- **황혼전**: 명성 72,688, 버퍼 버프력 5,200,000, 딜러 총딜 12,000,000,000
